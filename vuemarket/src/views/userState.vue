<template>
            ...
            <el-main>
                <el-table :data="tableData">
                    ...
                    <el-table-column fixed="right" label="操作"width="200">
                        <template slot-scope="scope">
                            <el-button @click="edit1(scope.row)" type="text" size="small">查看</el-button>
    ...
    <el-button type="primary" @click="DELETE()">确 定</el-button>
        ...
        <el-dialog title="审核详情" :visible.sync="dialogVisible">
      <span>
        状态：{{state}}<br>
    ...
    export default {
        ...
        methods:{
            edit(row) {
                ...
                this.form.c_state=-1
                this.form.c_reason=row.c_reason
            },
            edit1(row){
                const  _this=this
                ...
                if(row.c_state==-1&&row.c_reason!=null){
                    _this.state="审核被打回"
                    _this.reason=row.c_reason
                }
            },
            addC(form){
                const _this=this
